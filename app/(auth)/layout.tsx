          ...
          <div className="space-y-6">
            <div className="space-y-3">
              ...
              <p className="max-w-sm text-sm leading-relaxed text-zinc-400">
                Open remote sessions on your devices via SSH, VNC, RDP, or Telnet, all in one place with Apache Guacamole.
              </p>
            </div>
            <a
            ...
            >
              ...
              <span className="underline-offset-4 group-hover:underline">Powered by Apache Guacamole</span>
