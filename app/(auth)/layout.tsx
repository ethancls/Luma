          ...
          <div className="space-y-6">
            <div className="space-y-3">
              ...
              <p className="max-w-sm text-sm leading-relaxed text-zinc-400">
                Open remote sessions on your devices via SSH, VNC, RDP, or Telnet, all in one place with{' '}
                <a
                  href="https://github.com/apache/guacamole-server"
                  target="_blank"
                  rel="noreferrer"
                  className="group inline-flex items-center gap-1 text-zinc-400 underline-offset-4 transition-colors hover:text-white hover:underline"
                >
                  Apache Guacamole
